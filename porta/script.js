let nav_img_x = document.querySelector('.x');
let nav_img_bars = document.querySelector('.bars');
let navbar = document.querySelector('.list');
let body=document.querySelector('body');

nav_img_bars.onclick = function() {
    navbar.classList.add('mostrar');
    nav_img_bars.classList.add("desaparecer");
}

nav_img_x.onclick = function() {
    navbar.classList.remove('mostrar');
    nav_img_bars.classList.remove("desaparecer");
